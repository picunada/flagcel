<script lang="ts" module>
	...
	export const buttonVariants = tv({
		base: 'ios-corners-sm motion-press inline-flex items-center justify-center gap-2 whitespace-nowrap text-xs uppercase tracking-[0.1em] transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-40',
		variants: {
			variant: {
				default:
