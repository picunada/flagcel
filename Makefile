...
help:
	...
	@echo "  wasm            build evalcore WASI preview1 reactor for JS and Python SDKs"
...
wasm:
	mkdir -p bin sdks/js sdks/python/flagcel_openfeature
	...
	cp bin/flagcel_eval.wasm sdks/python/flagcel_openfeature/flagcel_eval.wasm
...
clean:
	rm -rf bin web/build web/.svelte-kit sdks/js/flagcel_eval.wasm sdks/python/flagcel_eval.wasm sdks/python/flagcel_openfeature/flagcel_eval.wasm
